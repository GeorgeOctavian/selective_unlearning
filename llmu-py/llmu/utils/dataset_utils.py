...
import re
from llmu.utils.ufl_utils import normalize_reply
from llmu.constants.dataset_constants import DIALOG_DATASETS


class UFLDataset(Dataset):
    def __init__(
            self,
            tokenizer,
            dataset_name,
    ...
    def convert_to_features(self, example_batch):
        ...
        if self.type_path == 'train':
            ...
            if 'lambada' in self.dataset_name:
                ...
                ds_parts = self.dataset_name.split("/")
                task = ds_parts[-1].split(".")[0]
                task_type = 'dialog'
